...
export async function generatePresentationContent(topic) {
  try {
    ...
    const prompt = `Generate a professional presentation structure for the topic: "${topic}". 
      ...
      "slides": [
        {
          ...
          "imageKeyword": "detailed visual description for an AI image generator representing this slide"
        }
      ]
    }
    The presentation should have 5-8 slides. 
    Slide 1 should be the Title Slide. 
