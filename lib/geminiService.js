...
SLIDE STRUCTURE:
1. Title Slide: Compelling title with a powerful tagline/subtitle
2-${slideCount - 1}. Content Slides: Each focusing on a specific aspect of the topic
${slideCount}. Closing Slide: Call-to-action, key takeaways, or thank you with contact info
...
Return a strictly valid JSON object:
{
  ...
  "slides": [
    {
      "title": "Specific Slide Title",
      "content": ["Detailed point with specifics", "Another informative point", "Third key insight"],
