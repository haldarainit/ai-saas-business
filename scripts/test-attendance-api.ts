 ...
 * Run: node scripts/test-attendance-api.ts
 */
...
async function testAPI(name: string, method: string, endpoint: string, body: any = null) {
    console.log(`\n🧪 Testing: ${name}`);
...
async function runTests() {
    ...
    const employeesResult: any = await testAPI(
        'Get All Employees',
        'GET',
