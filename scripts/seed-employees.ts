 ...
 * 
 * Run: npx ts-node scripts/seed-employees.ts
 */
...
const Employee = mongoose.models.Employee || mongoose.model<EmployeeType>('Employee', employeeSchema);

const demoEmployees: EmployeeType[] = [
    {
        employeeId: 'EMP001',
        name: 'John Doe',
...
async function seedEmployees(): Promise<void> {
    try {
        ...
        console.log('\nCreated Employees:');
        result.forEach((emp: EmployeeType) => {
