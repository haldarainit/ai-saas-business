...
export default function ImageGenerator({ onBack }: ImageGeneratorProps) {
    ...
    const handleAnalyzeAndGenerate = async (): Promise<void> => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                        ...
                        >
                            ...
                            <button
                                ...
                                className={`w-full py-4 rounded-xl font-semibold text-lg flex items-center justify-center gap-3 transition-all ${uploadedImage && prompt && !isAnalyzing && !isGenerating
