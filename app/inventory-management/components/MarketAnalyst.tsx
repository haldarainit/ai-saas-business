...
export default function MarketAnalyst() {
    ...
    const analyzeMarket = async (): Promise<void> => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to analyze market trends';
            toast({
                title: 'Error',
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-1">
                                            {Array.isArray(product.topCompetitors)
                                                ...
                                                : (product.topCompetitors as string).split(',').map((competitor, idx) => (
                                                    <Badge key={idx} variant="outline" className="text-xs">
                                                        {competitor.trim()}
                                                    </Badge>
                                                ))
