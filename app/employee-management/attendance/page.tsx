                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${record.status === "present"
                          ...
                          {attendanceData.map((record: any) => (
                            <tr key={record._id} className="border-b last:border-0 hover:bg-muted/50">
                              ...
                              <td className="p-3 md:p-4">
                                <span className={`px-2 sm:px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${record.status === "present"
                                  ? "bg-green-500/20 text-green-600"
                                  : record.status === "absent"
                                    ? "bg-red-500/20 text-red-600"
                                    : record.status === "late"
